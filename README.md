...
2023年2月にフリーランスとして独立。スタートアップ企業を中心に開発、PM業務に従事。フロントエンド実装、バックエンド実装、技術調査、周辺ツール整備、顧客折衝、ドキュメント整備など経験から必要と感じた内容について領域問わず幅広く提案、実行までを受け持つ。
...
- 一定の見通しを立ててから開発に着手するスタイルを好みます。ありがたいことに開発速度とコード品質については褒めていただくことが多いです。
...
### eギフトツール業務（2023/05 ~ 現在）

- 概要：
- プロジェクト規模：7人
- 技術：Node.js(ver. 16.x) / Next.js(ver. 13.x) / Amazon API Gateway / AWS Lambda / AWS AppSync / DynamoDB / Shopify
- 業務内容：PM業務、開発業務を中心にしつつ事業を推進するPdMに近い領域も業務を行っています。開発業務はもちろん、業務委託での参画ながらスタートアップ企業の一員としてその時々に必要な動きを自身で考え、オーナーシップを持って業務を推進していきました。
